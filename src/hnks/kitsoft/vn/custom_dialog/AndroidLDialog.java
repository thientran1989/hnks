...
public class AndroidLDialog extends Dialog {
    ...
    */
    ...
    public void setPositiveButton(String text,View.OnClickListener onClickListener,int color){
    ...
    static public class Builder {
        ...
        */
        ...
        public AndroidLDialog show(){
            ...
            androidLDialog.setPositiveButton(this.buttonText1,onClickListener1,context.getResources().getColor(R.color.cam_500));
